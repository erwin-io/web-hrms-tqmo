...
var patientController = function() {
    ...
    var apiService = function (apiURI) {
        ...
        var getAddressByLegalEntityId = function (legalEntityId) {
            return $.ajax({
                url: apiURI + "Patient/GetAddressByLegalEntityId?legalEntityId=" + legalEntityId,
                type: "GET",
                contentType: 'application/json;charset=utf-8',
                dataType: "json",
                headers: {
    ...
    var form,formLegalEntityAddress,dataTablePatient,dataTableLegalEntityAddress;
    var appSettings = {
        model: {},
        status:{ IsNew:false},
        currentId:null
    ...
    var init = function (obj) {
        ...
        $(window).resize(function () {
            if ($("#table-patient").hasClass('collapsed')) {
    ...
    var initEvent = function () {
        ...
        $("#table-patient tbody").on("click", "tr .dropdown-menu a.edit", function () {
            appSettings.currentId = $(this).attr("data-value");
            Edit();
        });
        $("#table-patient tbody").on("click", "tr .dropdown-menu a.remove", function () {
            appSettings.currentId = $(this).attr("data-value");
            Delete();
        });

        $('#table-patient tbody').on('click', 'tr', function () {
            if(dataTablePatient.row(this).data()){
                appSettings.currentId = dataTablePatient.row(this).data().PatientId;
                var isSelected = !$(this).hasClass('selected');
                if (isSelected && $("#table-patient").hasClass('collapsed')) {
                    $("#btnDelete").removeClass("hidden");
                    $("#btnEdit").removeClass("hidden");
                } else {
                    $("#btnDelete").addClass("hidden");
    ...
    var initGrid = function() {
        dataTablePatient = $("#table-patient").DataTable({
            processing: true,
            responsive: {
                details: {
                    type: 'column',
            ...
            "serverSide": true,
            "ajax": {
                "url": app.appSettings.HRMSAPIURI + "Patient/GetPage",
                "type": "GET",
                "datatype": "json",
                contentType: 'application/json;charset=utf-8',
                headers: {
            ...
            "language": {
                ...
                "sLengthMenu": "<div class='patient-lookup-table-length-menu form-group pmd-textfield pmd-textfield-floating-label'><label>Rows per page:</label>_MENU_</div>",
                "sSearch": "",
            ...
            "initComplete": function (settings, json) {
                $(".patient-lookup-table-length-menu select").select2({
                    theme: "bootstrap",
        ...
        dataTablePatient.columns.adjust();
    };
    ...
    var Add = function(){
        ...
        //end reset model
        //render template
        patientTemplate.link("#modal-dialog .modal-body", appSettings.model);
    ...
    var Edit = function () {
        if (appSettings.currentId !== null || appSettings.currentId !== undefined || appSettings.currentId !== "") {
            ...
            api.getById(appSettings.currentId).done(function (data) {
                ...
                //    CivilStatusId: data.Data.CivilStatus.CivilStatusId,
                //};
                ...
                appSettings.model.CivilStatusId = data.Data.CivilStatus.CivilStatusId;
                ...
                //            circleProgress.show(true);
                //            $.ajax({
                //                    url: app.appSettings.HRMSAPIURI + "/Patient/RemovePatientAddress/" + $(this).attr("data-value"),
                //                    type: 'DELETE',
                //                    dataType: "json",
                //                    contentType: 'application/json;charset=utf-8',
                //                    headers: {
                ...
                //                $.ajax({
                //                        url: app.appSettings.HRMSAPIURI + "/Patient/createPatientAddress",
                //                        type: 'POST',
                //                        dataType: "json",
                //                        contentType: 'application/json;charset=utf-8',
                //                        headers: {
                ...
                //                $.ajax({
                //                        url: app.appSettings.HRMSAPIURI + "/Patient/UpdatePatientAddress",
                //                        type: 'PUT',
                //                        dataType: "json",
                //                        contentType: 'application/json;charset=utf-8',
                //                        headers: {
    ...
    var LoadPatientAddress = function(){
        appSettings.model.LegalEntityAddress = [];
        ...
        if(appSettings.status.IsNew){
            ...
            .then((result) => {
                if (result.value) {
                    ...
                    circleProgress.show(true);
                    $.ajax({
                        url: app.appSettings.HRMSAPIURI + "/Patient/",
                        type: 'POST',
                        dataType: "json",
                        contentType: 'application/json;charset=utf-8',
                        headers: {
        ...
        if (appSettings.currentId !== null || appSettings.currentId !== undefined || appSettings.currentId !== "") {
            ...
            .then((result) => {
                if (result.value) {
                    ...
                    circleProgress.show(true);
                    $.ajax({
                        url: app.appSettings.HRMSAPIURI + "/Patient/" + appSettings.currentId,
                        type: "DELETE",
                        contentType: 'application/json;charset=utf-8',
                        dataType: "json",
                        headers: {
