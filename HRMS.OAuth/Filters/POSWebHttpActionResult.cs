...
namespace HRMS.OAuth.Filters
{
    ...
    public class POSWebHttpActionResult<T> : IHttpActionResult
    {
        ...
        public POSWebHttpActionResult(HttpRequestMessage request, HttpStatusCode status, T content)
        {
