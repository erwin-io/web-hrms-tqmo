    ...
    public class DoctorController : ApiController
    {
        ...
        public IHttpActionResult GetPage(int Draw, string Search, int PageNo, int PageSize, string OrderColumn, string OrderDir)
        {
            ...
            try
            {
                ...
                return new SilupostAPIHttpActionResult<DataTableResponseModel<IList<DoctorViewModel>>>(Request, HttpStatusCode.OK, response);
            }
            catch (Exception ex)
            {
        ...
        public IHttpActionResult Get(string id)
        {
            ...
            if (string.IsNullOrEmpty(id))
            {
                ...
                return new SilupostAPIHttpActionResult<AppResponseModel<DoctorViewModel>>(Request, HttpStatusCode.BadRequest, response);
            }
            ...
            try
            {
                ...
                if (result != null)
                {
                    ...
                    return new SilupostAPIHttpActionResult<AppResponseModel<DoctorViewModel>>(Request, HttpStatusCode.OK, response);
                }
                else
                {
                    response.Message = Messages.NoRecord;
                    return new SilupostAPIHttpActionResult<AppResponseModel<DoctorViewModel>>(Request, HttpStatusCode.NotFound, response);
                }
        ...
        public IHttpActionResult Create([FromBody] CreateDoctorBindingModel model)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(id))
                {
                    ...
                    response.Data = result;
                    return new SilupostAPIHttpActionResult<AppResponseModel<DoctorViewModel>>(Request, HttpStatusCode.Created, response);
                }
                else
                {
        ...
        public IHttpActionResult Update([FromBody] UpdateDoctorBindingModel model)
        {
            ...
            try
            {
                ...
                {
                    response.Message = Messages.Failed;
                    return new SilupostAPIHttpActionResult<AppResponseModel<DoctorViewModel>>(Request, HttpStatusCode.BadGateway, response);
                }
            }
            catch (Exception ex)
            {
